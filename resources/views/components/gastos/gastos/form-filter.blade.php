...
<div class="flex justify-between pb-6">
    <form method="GET" class="col-span-3 flex justify-center items-center" x-data x-ref="form">
        ...
        <x-form-input name="cuenta_id" type="select" :options="$selectCuentas" @change="$refs.form.submit()"/>
        ...
        <x-form-input name="mes" :value="today()->month" type="selectMonth" @change="$refs.form.submit()" />
    </form>
