...
<div class="row">
    ...
    <div class="col-md-4 col-md-offset-4 well">
        ...
        {{ Form::open(['id'=>'frm_login', 'class'=>'form-horizontal']) }}
            ...
            @if ($userHasPassword)
            <div class="control-group col-md-10 col-md-offset-1 {{ $errors->has('clave_anterior') ? 'has-error' : '' }}">
            ...
            <div class="control-group col-md-10 col-md-offset-1 {{ $errors->has('nueva_clave') ? 'has-error' : '' }}">
            ...
            <div class="control-group col-md-10 col-md-offset-1 {{ $errors->has('nueva_clave_confirmation') ? 'has-error' : '' }}">
