...
<div class="row mt-md-4 mx-md-5">
    ...
    <div class="col-md-2 my-md-2 text-right">
        <a href="" class="btn btn-light border py-md-1 shadow-sm" data-toggle="modal" data-target="#modalBorrar">
        ...
        <a href="{{ route($routeName.'.edit', [$resource->getName(), $resource->model()->getKey()]) }}" class="btn btn-primary border py-md-1 shadow-sm">
