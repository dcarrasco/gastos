...
<a class="btn py-0 px-1 text-muted"
    ...
    data-url-form="{!! route($routeName.'.destroy', [$resource['resource']->getName(), $resource['resource']->model()->getKey()]) !!}"
    data-message="{!! trans('orm.delete_confirm', ['model' => $resource['resource']->getLabel(), 'item' => $resource['resource']->title() ]) !!}"
    id="delete-href"
>
