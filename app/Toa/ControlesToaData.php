...
{
    public static function getControlTecnicosData(
        $empresa = null,
        $fechaDesde = null,
        $fechaHasta = null,
        $peticiones = null,
    ...
    public static function getControlMaterialesData(
        $empresa = null,
        $fechaDesde = null,
        $fechaHasta = null,
        $filtroTrx = null,
        ...
        return DB::table(DB::raw(config('invfija.bd_movimientos_sap_fija').' a'))
            ...
            ->leftJoin(
                DB::raw(config('invfija.bd_tip_material_trabajo_toa').' e'),
                'd.id_tip_material_trabajo',
                '=',
                'e.id'
            )
            ...
            ->select([
                ...
                'a.ume',
                'e.desc_tip_material',
                DB::raw($datoDesplegar[$selectDato].' as dato')
            ])
